...
-export([usual_map/2, simple_pmap/2, portion_pmap/3, limited_pmap/4, distributed_pmap/5]).
...
limited_pmap(Fun, SourceList, PortionSize, WorkerCount) ->
	...
	parallel_limited_helper:limited_core(SourceList, PortionSize, WorkerList, fun lists:append/1).
