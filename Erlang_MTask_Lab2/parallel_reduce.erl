...
-export([usual_reduce/3, portion_reduce/4, portion_gen_reduce/4, limited_reduce/5, distributed_reduce/6]).
...
limited_reduce(Fun, SourceList, {InitValue, PortionInitValue}, PortionSize, WorkerCount) ->
	...
	parallel_limited_helper:limited_core(ReduceFun, SourceList, PortionSize, WorkerList).
